...
with open(input_csv) as file:
  ...
  action_number = 0
  threshold = 45
  result_arr = np.zeros(3) # real_time, video_time, hand_knee_distance, is_action
  result_csv = np.empty((0,3))
  ...
  for line in file:
    ...
    result_arr = [round(row_counter/20, 2), distance_hand_knee, elbow] #video time into first col
